...
#include "../DataStructure/CurveInfo.h"
#include "../DataStructure/EdgeInfo.h"
#include "../DataStructure/TriangleInfo.h"
#include "../Utility/Configure.h"
#include "../DataStructure/Boundary.h"
#include "../DataStructure/Hole.h"
#include "../DataStructure/Tile.h"
#include "../DataStructure/SubKey.h"
...
typedef boost::unordered_map< __int64_t, size_t> wekhashmap;
...
//protected:
	...
	//FOR LIFAN
	void loadCurves(vector<vector<vector<float> > > &inCurves);
	void loadNormals(vector<vector<vector<float> > > &inNorms);
	void saveResults(int &_numofpoints, int &_numoftilingtris, float * _pPositions, float * _pNormals, int * _pFaceIndices);
	void saveResults(vector<vector<int> > & sufF);
    ...
    __int64_t GetBitKey(const vector<int>& canItem,const vector<int>& allItem);
	void RecoverListFromBitKey(const vector<int>& list, __int64_t key,vector<int>& outlist );
	...
	//-------------Tiles
	int newTile(__int64_t wec, float c, int t, int nxt1, int nxt2);
	int appendTile(__int64_t wec, float c, int t, int nxt1, int nxt2, vector<int> &curTile);
	void appendTile(__int64_t wec, float c, int t, int nxt1, int nxt2, vector<OneTile> &locTileVec);
