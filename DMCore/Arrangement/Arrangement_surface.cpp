...
// Amani merging according to Equations (7), (8) and (9)
...
void Arrangement::sufCell_SmoothPatch( const int _nSub, const int _lapOrder, const int _lapIter ){
    ...
    ////float *vertices   = inputMesh.getPositions();  // array 3 times the size of number of vertices��access vertex position data
